...
var ExchangePage = (function () {
    ...
    ExchangePage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_2__services_logger_service__["a" /* Logger */],
            __WEBPACK_IMPORTED_MODULE_3__services_poloniex_service__["a" /* PoloniexService */],
...
var AccountPage = (function () {
    function AccountPage(navCtrl, poloniex, utils, storage, logger, loadingCtrl) {
        this.navCtrl = navCtrl;
        this.poloniex = poloniex;
        this.utils = utils;
        this.storage = storage;
    ...
    AccountPage.prototype.cancelOrder = function (order, market) {
        var _this = this;
        var loading = this.loadingCtrl.create();
        loading.present();
        this.poloniex.api('cancelOrder', [
            ...
            __WEBPACK_IMPORTED_MODULE_5__services_logger_service__["a" /* Logger */].log(res);
            loading.dismiss();
            _this.logger.alert('Success', 'Your order #' + order.orderNumber + ' was canceled.', ['OK']);
        });
    };
...
var PoloniexService = (function () {
    ...
    PoloniexService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["A" /* Injectable */])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4__logger_service__["a" /* Logger */],
